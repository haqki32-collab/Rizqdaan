...
const FavoritesPage: React.FC<FavoritesPageProps> = ({ user, listings, onNavigate }) => {
  // Use state derived from user props, which come from App's Firestore listener
  ...
  return (
    <div className="animate-fade-in pb-20">
      <header className="flex items-center mb-6">
        ...
        <span className="ml-2 text-sm text-gray-500 font-medium">({favoriteListings.length})</span>
      </header>
