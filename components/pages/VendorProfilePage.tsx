        ...
        <div className="px-4 relative pb-6">
            ...
            <div className="mt-2 space-y-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button 
                        id="vendor-message-btn"
                        onClick={() => {
                            onNavigate('chats', { targetUser: { id: vendor.id, name: vendor.shopName || vendor.name } });
                        }}
                        className="flex-1 py-3 bg-accent-blue text-white rounded-xl font-black uppercase text-xs tracking-widest shadow-lg flex items-center justify-center gap-2 cursor-pointer"
                    >
